...
namespace RecipeSharingPlatform.Data.Migrations
{
    ...
    [Migration("20250705091758_ChangeDeleteBehavior")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4d6f43b3-bc16-43b5-a739-75ab3d60d2ff",
                            Email = "admin@recipesharing.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@RECIPESHARING.COM",
                            NormalizedUserName = "ADMIN@RECIPESHARING.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEIAB+04+oSkUDkafeQqzIVof/3pV347wGJg1agM7rzjCdJH7x2NsUOyqAACT8THh1g==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "cf2d36c5-5936-451b-8523-6afa3775ddd8",
            ...
            modelBuilder.Entity("RecipeSharingPlatform.Data.Models.Recipe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            CreatedOn = new DateTime(2025, 7, 5, 12, 17, 58, 392, DateTimeKind.Local).AddTicks(7988),
                        ...
                        new
                        {
                            ...
                            AuthorId = "df1c3a0f-1234-4cde-bb55-d5f15a6aabcd",
                            CategoryId = 2,
                            CreatedOn = new DateTime(2025, 7, 5, 12, 17, 58, 392, DateTimeKind.Local).AddTicks(8040),
                        ...
                        new
                        {
                            ...
                            AuthorId = "df1c3a0f-1234-4cde-bb55-d5f15a6aabcd",
                            CategoryId = 3,
                            CreatedOn = new DateTime(2025, 7, 5, 12, 17, 58, 392, DateTimeKind.Local).AddTicks(8043),
            ...
            modelBuilder.Entity("UsersRecipes", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("RecipeSharingPlatform.Data.Models.Recipe", b =>
                {
                    ...
                    b.HasOne("RecipeSharingPlatform.Data.Models.Category", null)
                        .WithMany("Recipes")
            ...
            modelBuilder.Entity("UsersRecipes", b =>
                {
                    b.HasOne("RecipeSharingPlatform.Data.Models.Recipe", null)
                        .WithMany()
